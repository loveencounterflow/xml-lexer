  ...
  create = function(settings, handler) {
    ...
    lexer.stateMachine = {
      ...
      [State.atr_name]: {
        //.....................................................................................................
        [Action.space]: (src, idx, chr) => {
          return ρ.state = State.atr_name_end;
        },
        //.....................................................................................................
        [Action.equal]: (src, idx, chr) => {
          emit('^11^', src, idx, Type.atr_name, ρ.attr_name);
          return ρ.state = State.atr_value_begin;
        },
        //.....................................................................................................
        [Action.gt]: (src, idx, chr) => {
          ρ.atr_value = '';
      ...
      [State.atr_value_begin]: {
        ...
        [Action.quote]: (src, idx, chr) => {
          ρ.prv_quote = chr;
          ρ.atr_value = '';
          return ρ.state = State.atr_value;
        },
        //.....................................................................................................
        [Action.gt]: (src, idx, chr) => {
          ρ.atr_value = '';
      ...
      [State.atr_value]: {
        ...
        [Action.space]: (src, idx, chr) => {
          if (ρ.prv_quote.length > 0) {
            ...
            return ρ.state = State.atr_name_start;
          }
        },
        //.....................................................................................................
        [Action.quote]: (src, idx, chr) => {
