    ...
    lexer.stateMachine = {
      ...
      state_tag_begin: {
        ...
        action_space: (src, idx, chr) => {
          return emit('^d10^', src, idx, name_info, chr);
        },
        //.....................................................................................................
        action_chr: (src, idx, chr) => {
      ...
      state_tagname: {
        ...
        action_space: (src, idx, chr) => {
          ...
          if (ρ.is_closing) {
            ...
            return emit('^d14^', src, idx, name_open, ρ.tagname);
          }
        },
        //.....................................................................................................
        ...
        action_slash: (src, idx, chr) => {
          ...
          return emit('^d20^', src, idx, name_open, ρ.tagname);
        },
        //.....................................................................................................
        action_chr: (src, idx, chr) => {
      ...
      state_tag_end: {
        ...
        action_chr: (src, idx, chr) => {
          ...
          return emit('^d27^', src, idx, name_extraneous, chr);
        }
      },
      //-------------------------------------------------------------------------------------------------------
      state_atrname_start: {
        ...
        //.....................................................................................................
        action_space: (src, idx, chr) => {
          return emit('^d34^', src, idx, name_info, chr);
        },
        //.....................................................................................................
        action_slash: (src, idx, chr) => {
      ...
      state_atrname_end: {
        ...
        action_space: (src, idx, chr) => {
          ...
          return emit('^d48^', src, idx, name_noop, chr);
        },
        //.....................................................................................................
        action_equal: (src, idx, chr) => {
      ...
      state_atrvalue_begin: {
        //.....................................................................................................
        action_space: (src, idx, chr) => {
          return emit('^d58^', src, idx, name_info, chr);
        },
        //.....................................................................................................
