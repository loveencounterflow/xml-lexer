    ...
    lexer.stateMachine = {
      ...
      state_tagname: {
        ...
        action_space: (src, idx, chr) => {
          ...
          if (ρ.is_closing) {
            ...
            return emit('^d11^', src, idx, name_open, ρ.tagname);
          }
        },
        //.....................................................................................................
        ...
        action_slash: (src, idx, chr) => {
          ...
          return emit('^d17^', src, idx, name_open, ρ.tagname);
        },
        //.....................................................................................................
        action_chr: (src, idx, chr) => {
      ...
      state_tag_end: {
        ...
        action_gt: (src, idx, chr) => {
          ...
          console.log('^37376^', idx, chr, src.slice(idx - 5, +(idx + 5) + 1 || 9e9), ρ.is_closing, ρ.has_slash);
          if (ρ.has_slash) {
            ρ.has_slash = false;
      ...
      state_atrname_start: {
        ...
        //.....................................................................................................
        action_space: (src, idx, chr) => {
          return emit('^d26^', src, idx, name_info, chr);
        },
        //.....................................................................................................
        action_slash: (src, idx, chr) => {
      ...
      state_atrname_end: {
        ...
        action_space: (src, idx, chr) => {
          ...
          return emit('^d42^', src, idx, name_noop, chr);
        },
        //.....................................................................................................
        action_equal: (src, idx, chr) => {
      ...
      state_atrvalue_begin: {
        //.....................................................................................................
        action_space: (src, idx, chr) => {
          return emit('^d52^', src, idx, name_info, chr);
        },
        //.....................................................................................................
